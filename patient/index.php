                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <!-- <h4>CHECK YOUR CONDITION FIRST </h4>
                            ...
                            <!-- <h5> IF YOU ARE THE REPRESENTATIVE, PLEASE MAKE SURE THE PATIENT TO CHECK THEIR CODITION DAILY </h5> --> 
                            <!-- <a href="condition.php" class="non-style-link"><button class="btn-primary btn" style="width:30%">Check it now</button></a> -->
                                ...
                                <td>
                                    ...
                                    <center>
                                        ...
                                        <th class="table-headin">
                                                ...
                                                <a href="appointment.php" class="non-style-link"><button class="btn-primary btn" style="width:30%">CHECK IN </button></a>
                                        ...
                                        <tbody>
                                            ...
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                $sqlmain= "select * from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.patientID=appointment.patientID inner join doctor on schedule.doctorID=doctor.doctorID  where  patient.patientID=$userid  and schedule.scheduledate>='$today' order by schedule.scheduledate asc";
                                                //echo $sqlmain;
