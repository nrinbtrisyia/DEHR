            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-doctor-active">
                        <a href="doctors.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Record</p></a></div>
                    </td>
                </tr>
...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Patient's Record  (<?php echo $list11->num_rows; ?>)</p>
                    </td>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from doctor where demail='$keyword' or fname='$keyword' or fname like '$keyword%' or fname like '%$keyword' or fname like '%$keyword%'";
                    }else{
                        $sqlmain= "select * from doctor order by doctorID desc";
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                // else{
                                    ...
                                    //     } else {
                                    //         // Handle the case where the query didn't return any data
                                    //         $spcil_name = "Unknown"; // Or any default value or error handling logic
                                    //     }
                                    ...
                                    //     <a href="?action=view&id='.$doctorID.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">View</font></button></a>
                                    //    &nbsp;&nbsp;&nbsp;
                                    //    <a href="?action=session&id='.$doctorID.'&name='.$name.'"  class="non-style-link"><button  class="btn-primary-soft btn button-icon menu-icon-session-active"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Sessions</font></button></a>
                                    //     </div>
                                    //     </td>
                                    // </tr>';
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $sqlmain = "SELECT * FROM doctor WHERE doctorID=?";
