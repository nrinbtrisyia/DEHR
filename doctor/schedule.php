 ...
 <div class="container">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                    ...
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <select name="doctorID" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            ...
                            <?php 
                                ...
                                $list11 = $database->query("select  * from  doctor order by fname asc;");
                ...
                <?php
                    if($_POST){
                        ...
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        $sqlmain= "select schedule.scheduleid,schedule.title,doctor.fname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join doctor on schedule.doctorID=doctor.doctorID ";
                        ...
                        $sqlmain= "select schedule.scheduleid,schedule.title,doctor.fname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join doctor on schedule.doctorID=doctor.doctorID  order by schedule.scheduledate desc";
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                <input type="text" name="doctorname" class="input-text" min="0"  value="'. $username .'" required><br><br><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    -->
                                    <select class="input-text" name="time" required>
            ...
            $sqlmain= "select schedule.scheduleid,schedule.title,doctor.fname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join doctor on schedule.doctorID=doctor.doctorID  where  schedule.scheduleid=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $docname=$row["fname"];
            $scheduleid=$row["scheduleid"];
            ...
            $sqlmain12= "select * from appointment inner join patient on patient.patientID=appointment.patientID inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.scheduleid=$id;";
