        ...
        <?php       
                    ...
                    if($_POST){
                        ...
                        if(isset($_POST["search"])){
                            ...
                            $sqlmain= "select * from patient where pemail='$keyword' or fullname='$keyword' or fullname like '$keyword%' or fullname like '%$keyword' or fullname like '%$keyword%' ";
                            $selecttype="my";
                        }
                        ...
                        if(isset($_POST["filter"])){
                            if($_POST["showonly"]=='all'){
                                ...
                                $sqlmain= "select * from appointment inner join patient on patient.patientID=appointment.patientID inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.doctorID=$userid;";
                                $selecttype="My";
                                $current="My patients Only";
                            }
                        }
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <?php
                               ...
                               //$list12= $database->query("select * from appointment inner join patient on patient.pid=appointment.pid inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.doctorID=1;");
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="insert.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
